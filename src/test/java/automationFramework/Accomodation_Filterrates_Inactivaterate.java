...
public class Accomodation_Filterrates_Inactivaterate {
	...
	Logger logger = Logger.getLogger("Inactive_rate");
			...
			test.log(LogStatus.FAIL, "Login");
	           ...
	           try {
				Thread.sleep(2000);
				    obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Rate-filter-screen.jpg");
					 ...
					 driverqa.findElement(RateFilter.accomname).sendKeys(excel.getData(5, 10, 0));
					 Thread.sleep(3000);
					 ...
					 Thread.sleep(2000);
					 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Inactive_new_rate/Rate-filter-screen.jpg");
	           ...
	           try {
				logger.info("Navigating to ContractList");
				   ...
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Inactive_new_rate/Final-Rate-filter-screen.jpg");
				   ...
				   JavascriptExecutor jse = (JavascriptExecutor) driverqa;
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(RateFilter.inactiveRateBttn));
					   ...
					   Thread.sleep(2000);
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Inactive_new_rate/Contract-List-screen.jpg");
