	  ...
	  public void pushrate(String browsername) throws Exception {
		...
		if (browsername.equalsIgnoreCase("CH")) {
			...
			test.log(LogStatus.FAIL, "Login");
	           ...
	           try {
				Thread.sleep(2000);
				    obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Rate-filter-screen.jpg");
	           ...
	           try {
				logger.info("Navigating to ContractList");
				   ...
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Final-Rate-filter-screen.jpg");
				   ...
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Contract-List-screen.jpg");
				   Thread.sleep(2000);
	           ...
	           try {
				test.log(LogStatus.INFO, "Adding new rates");
				   ...
				   Thread.sleep(3000);
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Contract-selection-screen.jpg");
				   driverqa.findElement(AddRate.ratenpolicy).click();
				   wait.until(ExpectedConditions.visibilityOfElementLocated(AddRate.adultrate));
				   driverqa.findElement(AddRate.adultrate).sendKeys(excel.getData(3, 7, 0));
				   Thread.sleep(3000);
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Rate-Add-screen.jpg");
				   ...
				   Thread.sleep(2000);
				   obj.Takesnap(driverqa, Config.SnapShotPath() + "/Publish_new_rate/Rates_Pushed.jpg");
