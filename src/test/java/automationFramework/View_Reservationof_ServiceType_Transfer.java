	...
	public void searchaccomodation() throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer_booking_for_adults_with_children/Customer-list-transfer-book.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer_booking_for_adults_with_children/Search-Hotel-filters-transfer-book.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer_booking_for_adults_with_children/Selected-transfer type-available-book-transfer.jpg");
			Thread.sleep(1000);
			...
			obj.Takesnap(driverqa,
					"D:/Test Repository/Test Screenshots/Transfer_booking_for_adults_with_children/Passenger-Details-transfer-book.jpg");
			driverqa.findElement(NewAccoBooking.bookBtn).click();
			logger.info("Entered Passenger details");
			Thread.sleep(4000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer_booking_for_adults_with_children/Confirm-Booking-transfer-book.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer_booking_for_adults_with_children/Reservation-productType-transfers.jpg");
			Assert.assertTrue(result.contains(expected));
